...
class UserServiceTest {
    ...
    void testLoginSuccessful() {
        ...
        when(passwordService.validatePassword(userLogin.getPassword(), user.getPasswordhash())).thenReturn(true);
        ...
        assertAll(
                ...
                () -> verify(passwordService).validatePassword(userLogin.getPassword(), user.getPasswordhash()),
    ...
    void testLoginUnsuccessful(){
        //Arrange
        when(userDao.findUserByUsername(userLogin.getUsername())).thenReturn(user);
        when(passwordService.validatePassword(userLogin.getPassword(), user.getPasswordhash())).thenReturn(false);
